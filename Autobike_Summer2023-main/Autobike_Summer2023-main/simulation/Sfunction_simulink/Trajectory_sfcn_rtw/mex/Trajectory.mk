...
MODEL                   = Trajectory
MODULES                 = Trajectory_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Trajectory_sf.mexw64
MAKEFILE                = Trajectory.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Trajectory_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = Trajectory_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Trajectory_ref.rsp
COMPILER_COMMAND_FILE     = Trajectory_comp.rsp
...
Trajectory_sf.obj : $(START_DIR)\Trajectory_sfcn_rtw\Trajectory_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Trajectory_sfcn_rtw\Trajectory_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\Trajectory_sfcn_rtw\Trajectory_sf.c

rtGetInf.obj : $(START_DIR)\Trajectory_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Trajectory_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\Trajectory_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\Trajectory_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\Trajectory_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\Trajectory_sfcn_rtw\rtGetNaN.c
