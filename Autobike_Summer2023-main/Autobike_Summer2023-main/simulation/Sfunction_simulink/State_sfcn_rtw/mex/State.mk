...
MODEL                   = State
MODULES                 = State_sf.c State_sf_data.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\State_sf.mexw64
MAKEFILE                = State.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2022b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2022b
START_DIR               = C:\Users\levi1\Documents\GitHub\Bikeproject_GB_LS
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:State_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = State_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = State_ref.rsp
COMPILER_COMMAND_FILE     = State_comp.rsp
...
State_sf.obj : $(START_DIR)\State_sfcn_rtw\State_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\State_sfcn_rtw\State_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\State_sfcn_rtw\State_sf.c

State_sf_data.obj : $(START_DIR)\State_sfcn_rtw\State_sf_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\State_sfcn_rtw\State_sf_data.c
	$(CC) $(CFLAGS) $(START_DIR)\State_sfcn_rtw\State_sf_data.c

rtGetInf.obj : $(START_DIR)\State_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\State_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\State_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\State_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\State_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\State_sfcn_rtw\rtGetNaN.c
