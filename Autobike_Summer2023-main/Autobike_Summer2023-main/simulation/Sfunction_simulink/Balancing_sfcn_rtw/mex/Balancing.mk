...
MODEL                   = Balancing
MODULES                 = Balancing_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Balancing_sf.mexw64
MAKEFILE                = Balancing.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Balancing_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = Balancing_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Balancing_ref.rsp
COMPILER_COMMAND_FILE     = Balancing_comp.rsp
...
Balancing_sf.obj : $(START_DIR)\Balancing_sfcn_rtw\Balancing_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Balancing_sfcn_rtw\Balancing_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\Balancing_sfcn_rtw\Balancing_sf.c

rtGetInf.obj : $(START_DIR)\Balancing_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Balancing_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\Balancing_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\Balancing_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\Balancing_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\Balancing_sfcn_rtw\rtGetNaN.c
