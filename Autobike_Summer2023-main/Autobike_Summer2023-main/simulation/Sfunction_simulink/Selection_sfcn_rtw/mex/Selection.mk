...
MODEL                   = Selection
MODULES                 = Selection_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Selection_sf.mexw64
MAKEFILE                = Selection.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Selection_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = Selection_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Selection_ref.rsp
COMPILER_COMMAND_FILE     = Selection_comp.rsp
...
Selection_sf.obj : $(START_DIR)\Selection_sfcn_rtw\Selection_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Selection_sfcn_rtw\Selection_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\Selection_sfcn_rtw\Selection_sf.c

rtGetInf.obj : $(START_DIR)\Selection_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Selection_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\Selection_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\Selection_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\Selection_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\Selection_sfcn_rtw\rtGetNaN.c
